...
tissues.
The MerfishData package contains two annotated samples assayd with the MERFISH
...
zooming in a small portion of the tissue.

```{r plotvoyager}
library(Voyager)
plotCellBin2D(jbr, hex = TRUE)
plotGeometry(jbr, "cellSeg", bbox=c("xmin"=0, "ymin"=4000, "xmax"=1000, "ymax"=5000))
```
...
plotSpatialFeature(jbr, "FASN", colGeometryName = "centroids",
                   scattermore = TRUE, ncol = 2, pointsize = 0.5) +
  ggtitle("FASN, invasive")

plotSpatialFeature(jbr, "POSTN", colGeometryName = "centroids",
                   scattermore = TRUE, ncol = 2, pointsize = 0.5) +
