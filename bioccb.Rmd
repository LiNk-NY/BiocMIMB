...
are given in section XX below.  For most assay types, we think of the quantitative
assay
...
```{r dothesurv,fig.cap="Survival profile extraction from three MultiAssayExperiments produced with curatedTCGAData calls.", fig.width="80%"}
library(survival)
